...
<div class="templatemo-flex-row">
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        <div class="templatemo-top-nav-container">
            <h1>Company Dashboard </h1><h3>(<?php echo $username; ?>)</h3>
        </div>
        <div class="templatemo-content-container">
            ...
            <div class="templatemo-flex-row flex-content-row">
                <div class="templatemo-content-widget white-bg col-2">
                    <h2 class="templatemo-inline-block">My Data</h2>
                    <div class="form-group text-right">
                        <a href="upload.php" class="templatemo-blue-button"><strong>+ Add Data</strong></a>
                    </div>
                    <?php
                    $data_sources = $company->getDataSources();
                    $count = count($data_sources);
                    if ($count == 0) {
                        echo "<hr><p>You haven't posted any data.</p>";
                    } else {
                        ?>
                        <hr>
                        <?php
                        echo "<div class='templatemo-flex-row flex-content-row'><div class='templatemo-content-widget blue-bg col-2'><h2 class='templatemo-inline-block'> Uploaded Data: {$count}</h2>";
                        foreach ($data_sources as $data_source) {
                            echo "<div class='col-1'>";
                            echo "<div class='templatemo-flex-row flex-content-row'><div class='templatemo-content-widget blue-bg col-2'><h2 class='templatemo-inline-block'>{$data_source->getName()}</h2><hr><p>{$data_source->getDescription()}</p><div class='form-group text-right'><a href='viewData.php?dataurl={$data_source->getUrl()}'  class='templatemo-white-button'>View</a></div></div></div>";
                            echo "</div>";
                        }
                        echo "</div></div>";
                    }
